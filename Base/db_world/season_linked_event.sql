...
CREATE TABLE `season_linked_event` (
  ...
  UNIQUE KEY `season` (`season`,`event`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 ROW_FORMAT=FIXED COMMENT='ArkDB Season linked by events system';
...
INSERT INTO `season_linked_event` VALUES (1,124),(2,125),(3,126),(4,127),(5,128),(6,129),(7,130),(8,131),(9,132);
