...
--
-- Table structure for table `lfg_dungeon_event`
--
...
CREATE TABLE `lfg_dungeon_event` (
  ...
  PRIMARY KEY (`dungeonId`,`eventEntry`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lfg_dungeon_event`
--

LOCK TABLES `lfg_dungeon_event` WRITE;
