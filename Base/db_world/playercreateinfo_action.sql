...
CREATE TABLE `playercreateinfo_action` (
  ...
  UNIQUE KEY `race` (`race`,`class`,`button`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED COMMENT='Player System';
...
-- Dump completed on 2023-07-11 11:40:36
